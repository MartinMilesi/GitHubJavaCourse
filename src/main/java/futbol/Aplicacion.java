...
public class Aplicacion {
	...
	public static void main(String[] args) {
		...
		if(args.length == 0) {
			System.out.println("No ingresaste ningun archivo de configuracion como argumento!");
			System.out.println("Utilizando configuracion default");
			System.out.println(" ");
			System.out.println("Utilizando Base de Datos Sql...");
			//Lector SQL.
			LectorSql lectorSql = new LectorSql();
			lectorSql.obtenerDatos("src/main/resources/configuracion.properties");
			System.out.println("Utilizando Archivos Csv de respaldo...");
			//Lector CSV.
			LectorCsv lectorCsv = new LectorCsv();
			lectorCsv.obtenerDatos("src/main/resources/configuracion.properties");
			System.out.println("Datos procesados, clases creadas, cerrando...");
			System.exit(88);
		}else {
			System.out.println("Utilizando Base de Datos Sql...");
			LectorSql lectorSql = new LectorSql();
			lectorSql.obtenerDatos(args[0]);
			System.out.println("Utilizando Archivos Csv indicados en configuracion...");
			LectorCsv lectorCsv = new LectorCsv();
			lectorCsv.obtenerDatos(args[0]);
			System.exit(88);
		}
//Echo  //*Implementar calculos para decidir un ganador entre los cuatro participantes.
//Echo	//*Recibir como argumento un archivo con la configuracion. (Conexion a Base de Datos, Puntaje por partido, Puntos Extras, etc).
